...
config :lumen, LumenWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "pNFaVI4X6Av33cgqbma4wR/p6ujJjGAoUkzshGAcQDIF4VtwKlnS+5e5+/9Cdotc",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:lumen, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:lumen, ~w(--watch)]}
  ]
...
config :lumen, LumenWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/lumen_web/(?:controllers|live|components|router)/?.*\.(ex|heex)$"
    ]
  ]
