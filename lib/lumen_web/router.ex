defmodule LumenWeb.Router do
  use LumenWeb, :router

  import LumenWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {LumenWeb.Layouts, :root}
  ...
  scope "/", LumenWeb do
    ...
    live "/public/:share_token", PublicDashboardLive
  end
  ...
  if Application.compile_env(:lumen, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: LumenWeb.Telemetry
  ...
  scope "/", LumenWeb do
    ...
    live_session :current_user,
      on_mount: [{LumenWeb.UserAuth, :mount_current_scope}] do
